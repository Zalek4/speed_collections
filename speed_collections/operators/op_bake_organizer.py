...
from ..utilities.utilities import traverse_tree, parent_lookup
import time
import random
...
class SPEEDSEAMS_OT_PairHighLowObjects(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bg_low_unmatched_name = sc.bakePrepAssetName + "_" + sc.bakePrepSuffixLow + "_" + "UNMATCHED"
        bg_high_name = sc.bakePrepAssetName + "_" + sc.bakePrepSuffixHigh
        bg_high_unmatched_name = sc.bakePrepAssetName + "_" + sc.bakePrepSuffixHigh + "_" + "UNMATCHED"
        ...
        if bg_collection and bg_high_collection and bg_low_collection:
            ...
            print("Search Distance : " + str(sc.searchDistance))
            print("-----------------------------------------------------------------")
            ...
            for lowObject in bg_low_collection.all_objects:
                ...
                if objectNumber <= 9:
                    mesh_low_name = sc.bakePrepAssetName + "_" + "00" + str(objectNumber) + "_" + sc.bakePrepSuffixLow
                    mesh_high_name = sc.bakePrepAssetName + "_" + "00" + str(objectNumber) + "_" + sc.bakePrepSuffixHigh
                elif objectNumber > 9:
                    mesh_low_name = sc.bakePrepAssetName + "_" + "0" + str(objectNumber) + "_" + sc.bakePrepSuffixLow
                    mesh_high_name = sc.bakePrepAssetName + "_" + "0" + str(objectNumber) + "_" + sc.bakePrepSuffixHigh
                elif objectNumber > 99:
                    mesh_low_name = sc.bakePrepAssetName + "_" + str(objectNumber) + "_" + sc.bakePrepSuffixLow
                    mesh_high_name = sc.bakePrepAssetName + "_" + str(objectNumber) + "_" + sc.bakePrepSuffixHigh
                #bpy.ops.wm.redraw_timer(type='DRAW_WIN_SWAP', iterations=1)
                ...
                #If more than one match was found, compare them with raytraces
                    ...
                    for highObject in highMatches:
                        ...
                        for i in range(indexRange):
                            ...
                            hit, loc, norm, idx, ob, M = scene.ray_cast(context.evaluated_depsgraph_get(), transformList[index], normalList[index], distance=sc.searchDistance)
